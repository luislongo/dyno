...
public class InputDetector implements StructureDrawGLSurface.StructureDrawSurfaceListener {
    ...
    private void onMoveEvent(MotionEvent event) {
        ...
        final Vector2 dxdy = Vector2.subtract(xy, lastTouch);

        currentTouch = Vector2.add(lastTouch, dxdy);
    ...
    private void notifyOnDrag(Vector2 distance) {
        ...
        final Vector2 viewCurrentTouch = Camera.fromScreenToView(SceneMaster.getMainCamera(), currentTouch);
