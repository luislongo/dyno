...
class MMathTest extends MMath {
    ...
    @Test void testTranspose() {
        ...
        MatrixF result = MMath.transpose(m);
    ...
    @Test void testIsSameDimensions() {
        ...
        assertEquals(true, MMath.isSameDimensions(m1, m2));
        assertEquals(false, MMath.isSameDimensions(m1, m3));
        assertEquals(false, MMath.isSameDimensions(m1, m4));
        assertEquals(false, MMath.isSameDimensions(m1, m5));
    }
    @Test void testIsMultiplicationDimension() {
        ...
        assertEquals(true, MMath.isMultiplicationDimension(m1, m2));
        assertEquals(true, MMath.isMultiplicationDimension(m1, m3));
        assertEquals(false, MMath.isMultiplicationDimension(m1, m4));
        assertEquals(false, MMath.isMultiplicationDimension(m1, m5));
    }
    ...
    @Test void testIsRowDimensionValid() {
        ...
        assertEquals(true, MMath.isRowDimensionValid(m, line1));
        assertEquals(false, MMath.isRowDimensionValid(m, line2));
        assertEquals(false, MMath.isRowDimensionValid(m, line3));
        assertEquals(false, MMath.isRowDimensionValid(m, line4));
    }
    @Test void testIsColDimensionValid() {
        ...
        assertEquals(true, MMath.isColDimensionValid(m, line1));
        assertEquals(false, MMath.isColDimensionValid(m, line2));
        assertEquals(false, MMath.isColDimensionValid(m, line3));
        assertEquals(false, MMath.isColDimensionValid(m, line4));
    }
}